...
const handleExportOtherFormat = () => {
    window.location.href = route('settings.data.exportOtherFormat');
                ...
                <!-- <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white">Exporter ma liste</h3>
                            <p class="text-sm text-gray-500 mt-1">
                                Téléchargez un fichier CSV contenant toute votre progression.
                            </p>
                        </div>
                        <Button @click="handleExportOtherFormat" variant="outline" class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                                <polyline points="7 10 12 15 17 10" />
